...
install_nsolid() {
  ...
  local download_url="https://s3-us-west-2.amazonaws.com/nodesource-public-downloads/2.3.1/artifacts/bundles/nsolid-bundle-v$version-$os-$cpu/nsolid-v$version-boron-$os-$cpu.tar.gz"
  echo $version $os $cpu
  echo $download_url
